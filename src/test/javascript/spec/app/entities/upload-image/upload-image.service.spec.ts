...
describe('Service Tests', () => {
  describe('UploadImage Service', () => {
    ...
    beforeEach(() => {
      ...
      expectedResult = {};
      injector = getTestBed();
      service = injector.get(UploadImageService);
      httpMock = injector.get(HttpTestingController);

      elemDefault = new UploadImage(0, 'AAAAAAA', 'AAAAAAA', 'image/png', 'AAAAAAA');
    });
